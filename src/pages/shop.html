...
<meta name="description" content="Shop every Korean Point skincare product — filter, search, and sort." />
<title>Shop — Korean Point</title>
...
<section class="section" id="shop">
  <div class="container">
    <header class="section__head">
      <p class="eyebrow">Loved by 120,000+</p>
      <h2 class="section__title">Shop All</h2>
      <p class="section__sub">Filter, search and sort — everything below is in stock today.</p>
    </header>

    <div class="toolbar">
      <div class="chips" id="filterChips" role="group" aria-label="Filter by category"></div>
      <div class="toolbar__right">
        ...
        <output class="toolbar__count" id="resultCount" aria-live="polite"></output>
      </div>
    </div>

    <div class="product-grid" id="productGrid"><!-- JS --></div>
    <p class="empty" id="emptyState" hidden>No products match. Try another filter.</p>
  </div>
</section>
</main>
